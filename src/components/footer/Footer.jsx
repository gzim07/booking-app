        ...
        <div className="footer">
            <div className="fLists">
                ...
                <u className="fList">
                    ...
                    <li className="fListItem">zzimbooking.com for Travel Agents</li>
                    
                </u>
            
           
                <u className="fList">
                    <li className="fListItem">About zzimbooking.com</li>
                    <li className="fListItem">All destinations</li>
             ...
             <div className="fText">Copyright &copy; 2022 zzimbooking&trade; </div>
